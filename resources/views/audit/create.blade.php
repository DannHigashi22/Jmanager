        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-success">
                    ...
                    <div class="card-body ">
                        <form id="formAuthentication" class="mb-3" action="{{route('audits.store')}}" method="POST">
                            @csrf
                          <div class="mb-4">
                            <label for="order" class="form-label">1. Pedido</label>
                            <input type="text" class="form-control form-control-border @error('order') is-invalid @enderror" id="order" name="order" value="{{ old('order') }}" placeholder="Numero de Pedido" autofocus/>
                            @error('order')
                          ...
                          <div class="mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('type') is-invalid @enderror" type="radio" name="type" id="type1" value="Despacho" {{old('type')=='Despacho'?'checked':''}}>
                                <label class="form-check-label mb-2" for="type1">Despacho</label> <br>
                           
                                <input class="form-check-input @error('type') is-invalid @enderror" type="radio" name="type" id="type2" value="Click auto" {{old('type')=='Click auto'?'checked':''}}>
                          ...
                          <div class="mb-4">
                            ...
                            <div class="form-check ">
                                ...
                                <input type="checkbox" name="error_type[]" id="{{$error}}" class="form-check-input @error('error_type') is-invalid @enderror" value="{{$id}}" {{(old('error_type'))?(in_array($id,old('error_type'))?'checked':''):''}}>
